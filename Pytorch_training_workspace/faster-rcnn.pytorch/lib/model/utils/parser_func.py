...
def parse_args():
    ...
    parser.add_argument('--save_dir', dest='models',
...
def set_dataset_args(args, test=False):
    if not test:
        ...
        '''
            ...
            args.imdb_name = "marine_debris_trainval"
            args.imdbval_name = "marine_debris_trainval"
            args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                             '30']        
        '''
        ...
        if args.dataset_t == "water":
            ...
            args.imdb_name_target = "marine_debris_trainval"
            args.imdbval_name_target = "marine_debris_trainval"
            args.set_cfgs_target = ['ANCHOR_SCALES', '[8, 16, 32]', 'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES',
                                    '30']        
